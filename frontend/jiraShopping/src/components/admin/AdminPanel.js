...
const AdminPanel = (props, ref) => {
    ...
    try {
      ...
      datas?.orders[0]?.products?.forEach((item) => {
        ...
        status = {
          ...
          delivererConfirmation: {
            ...status["delivererConfirmation"],
            [product]: item?.delivererConfirmation,
          },
          buyerConfirmation: {
            ...status["buyerConfirmation"],
            [product]: item?.buyerConfirmation,
          },
          deliveryDate: {
            ...status["deliveryDate"],
            [product]: item?.deliveryDate,
          },
        };
      });
      ...
      const orderDatas = {
        ...
        products: orders.products.map((el) => {
          return {
            ...
            buyerConfirmation:
              productsStatus["buyerConfirmation"][el.product] ||
              el.buyerConfirmation,
            delivererConfirmation:
              productsStatus["delivererConfirmation"][el.product] ||
              el.delivererConfirmation,
  ...
  const OrderProduct = (props) => {
    ...
    return (
      <View
        style={[
          adminPannelStyles.contents,
          { borderBottomWidth: 1, borderColor: appColors.lightWhite },
        ]}
      >
        <View style={[adminPannelStyles.titles]}>
          <Text style={[customText.text, adminPannelStyles.titlesText]}>
        ...
        <View style={[adminPannelStyles.line, {}]}>
          <View style={[adminPannelStyles.subTitle]}>
            <Text style={[customText.text, adminPannelStyles.subTitleText]}>
              Status
            </Text>
          </View>

          <Picker
            selectedValue={productsStatus["status"][item.product]}
            style={adminPannelStyles.picker}
            onValueChange={(itemValue, itemIndex) =>
              updateProductsStatus("status", item.product, itemValue)
            }
          >
        ...
        <View style={[adminPannelStyles.line, {}]}>
          <View style={[adminPannelStyles.subTitle]}>
            <Text style={[customText.text, adminPannelStyles.subTitleText]}>
              Deliverer Confirmation :{" "}
            </Text>
          </View>
          <Picker
            selectedValue={
              productsStatus["delivererConfirmation"][item.product]
            }
            style={adminPannelStyles.picker}
            onValueChange={(itemValue, itemIndex) =>
        ...
        <View style={[adminPannelStyles.line, {}]}>
          ...
          <Picker
            selectedValue={productsStatus["buyerConfirmation"][item.product]}
            style={adminPannelStyles.picker}
            onValueChange={(itemValue, itemIndex) =>
              updateProductsStatus("buyerConfirmation", item.product, itemValue)
            }
          >
            <Picker.Item label="Failed" value="0" />
            <Picker.Item label="Success" value="1" />
        ...
        <View style={[adminPannelStyles.line, {}]}>
          ...
          {!item.deliveryNo ? (
            <Pressable>
              <Text style={[customText.text, adminPannelStyles.titlesLabel]}>
                Generate
              </Text>
            </Pressable>
          ) : (
        ...
        <View style={[adminPannelStyles.line, {}]}>
          ...
          {!item.deliveryDate ? (
            <Pressable
              onPress={() => {
                updateProductsStatus(
                  "deliveryDate",
                  item.product,
                  !productsStatus["deliveryDate"][item.product]
                );
              }}
              style={[
                adminPannelStyles.deliveryDate,
                {
                  backgroundColor: productsStatus["deliveryDate"][item.product]
                    ? appColors.green
                    : appColors.gray,
                },
              ]}
            ...
            <View>
              <Text style={[customText.text, adminPannelStyles.titlesLabel]}>
                {formatDateToLitteral(item.deliveryDate)}
              </Text>
            </View>
          )}
        </View>
            ...
            <View style={[adminPannelStyles.group, {}]}>
              ...
              <View style={[adminPannelStyles.contents, {}]}>
                <View style={[adminPannelStyles.line, {}]}>
                  <View style={[adminPannelStyles.subTitle]}>
                    <Text
                      style={[customText.text, adminPannelStyles.subTitleText]}
                    >
                      Status :{" "}
                    </Text>
                  </View>
