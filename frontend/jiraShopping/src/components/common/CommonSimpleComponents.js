...
exports.LikeButton = (props) => {
  ...
  return (
    <Pressable
      style={[
        commonSimpleComponentsStyles.likeButton.likeIcon,
        isCard ? productStyles.card : false,
      ]}
        ...
        <View style={[{ flexDirection: "row" }]}>
          ...
          <Text
            style={[
              customText.text,
              { color: style.color },
              { fontSize: 8, fontWeight: styles.fontWeight || "bold" },
            ]}
          >
            {formatLikes(item.likes) || 1}
          </Text>
        </View>
      )}
    </Pressable>
...
exports.PrevButton = (props) => {
  ...
  const size = styles ? styles.size : 20;
  return (
    <Pressable
      onPress={() => {
        navigation.goBack();
...
exports.ShareButton = (props) => {
  ...
  return (
    <Pressable
      style={[commonSimpleComponentsStyles.shareButton]}
      onPress={() => {
        handleSharePress(link);
      }}
    >
      <BadgeIcon
        ...
        return (
          <View key={key}>
            <Facebook
              ...
              foregroundColor={appColors.skeletonForegrundColor}
            />
          </View>
        );
      })}
    ...
    <View style={commonSimpleComponentsStyles.conditionChoice.checkBox}>
      <Pressable style={[styles.itemContainer]}>
        <CheckBox
          ...
          onPress={() => {
            updateConditions("new");
          }}
          containerStyle={[styles.contentContainer, {}]}
          textStyle={[customText.text, styles.checkBoxText]}
        />
      </Pressable>
      ...
      <Pressable style={[styles.itemContainer]}>
        <CheckBox
          title="Utilisé"
          checked={conditions["old"]}
          onPress={() => {
            updateConditions("old");
          }}
          containerStyle={[styles.contentContainer, {}]}
          textStyle={[customText.text, styles.checkBoxText]}
        />
      ...
      <Pressable style={[styles.itemContainer]}>
        <CheckBox
          title="Peu Utilisé"
          checked={conditions["new used"]}
          onPress={() => {
            updateConditions("new used");
          }}
          containerStyle={[styles.contentContainer, {}]}
          textStyle={[customText.text, styles.checkBoxText]}
        />
...
exports.CustomActivityIndicator = (props) => {
  return (
    <View
      style={[commonSimpleComponentsStyles.activityIndicator.container, {}]}
    >
      <ActivityIndicator
        style={[
          commonSimpleComponentsStyles.activityIndicator.activityIndicator,
          {},
        ]}
        size="large"
...
exports.CustomModalActivityIndicator = (props) => {
  ...
  return (
    ...
    >
      <View
        style={[
          commonSimpleComponentsStyles.modalActivityIndicator.modalContainer,
        ]}
      >
        <View
          style={[
            commonSimpleComponentsStyles.modalActivityIndicator.modalContent,
          ]}
        >
  ...
  return (
    <View style={[commonSimpleComponentsStyles.counter.container]}>
      <Pressable
        style={[{}]}
        onPress={() => {
          setNumber(product, Math.max(num - 1, 1));
        }}
      >
      ...
      <Input
        ...
        inputStyle={[
          ...
          { color: appColors.clearBlack, fontSize: 12 },
        ]}
        underlineColorAndroid="transparent"
        style={[{ textAlign: "center" }]}
        containerStyle={[
          commonSimpleComponentsStyles.counter.containerStyleInput,
        ]}
        inputContainerStyle={[
          commonSimpleComponentsStyles.counter.inputContainer,
        ]}
      />
      <Pressable
        onPress={() => {
          setNumber(product, Math.min(num + 1, limit));
        }}
      >
...
exports.DisplayPrice = (props) => {
  ...
  return (
    <View style={[{ flexDirection: "row" }]}>
      <Text style={[customText.text, { top: 10, fontWeight: "bold" }]}>
        {formatMoney(choosePrice(product))} XAF
      </Text>
...
exports.TemporaryNotification = (props) => {
  ...
  return (
    <View
      style={[commonSimpleComponentsStyles.temporaryNotification.container, {}]}
    >
      <Text
        style={[
          customText,
          commonSimpleComponentsStyles.temporaryNotification.message,
        ]}
      >
        {message}
      </Text>
...
exports.PriceDetails = (props) => {
  ...
  const kargoPrice = products.reduce((total, prod) => {
    ...
    let toAdd;
    if (
      passed_products.some(
        (p) => p.seller._id == prod.seller._id && p.feesBy == "buyer"
      )
    ) {
      toAdd = 0;
    } else {
  ...
  product = {
    newPrice: totalPrice,
    feesBy: feesBy ? "buyer" : "seller",
    kargoPrice: kargoPrice,
    orderQuantity: products.reduce((t, p) => {
      return t + parseInt(p.orderQuantity || 1);
    }, 0),
  };
    ...
    <View style={[commonSimpleComponentsStyles.priceDetails.container]}>
      ...
      >
        <Text
          style={[
            customText.text,
            commonSimpleComponentsStyles.priceDetails.title,
          ]}
        >
          {title.toUpperCase()}
        </Text>
      ...
      <View style={[commonSimpleComponentsStyles.priceDetails.priceLine]}>
        <Text
          style={[
            customText.text,
            commonSimpleComponentsStyles.priceDetails.semiTitle,
          ]}
        >
          Prix Réel
        </Text>
        <Text
          style={[
            customText.text,
            commonSimpleComponentsStyles.priceDetails.price,
          ]}
        >
          {formatMoney(product.newPrice)} XAF
        </Text>
      </View>
      ...
      <View style={[commonSimpleComponentsStyles.priceDetails.priceLine]}>
        <View>
          ...
          >
            Payé par {product.feesBy === "seller" ? "vous" : "acheteur"}
          </Text>
        </View>
        <Text
          style={[
            customText.text,
            commonSimpleComponentsStyles.priceDetails.price,
            product.feesBy === "seller"
              ? { fontStyle: "italic", fontSize: 14 }
              : null,
          ]}
        >
          {product.feesBy === "buyer"
            ? `-${formatMoney(product.kargoPrice)} XAF`
            : "Payé par le vendeur"}{" "}
        </Text>
      </View>
      ...
      <View style={[commonSimpleComponentsStyles.priceDetails.priceLine]}>
        ...
        >
          -{formatMoney((product.newPrice * 10) / 100)} XAF
        </Text>
      </View>

      <View
        style={[
          commonSimpleComponentsStyles.priceDetails.priceLine,
          commonSimpleComponentsStyles.priceDetails.totalPriceLine,
        ]}
      >
        <Text
          style={[
            customText.text,
            commonSimpleComponentsStyles.priceDetails.semiTitle,
            commonSimpleComponentsStyles.priceDetails.totalPriceText,
          ]}
        >
          Total - Vos Gain
        </Text>
        ...
        >
          {formatMoney(product.newPrice - (product.newPrice * 10) / 100)} XAF
        </Text>
      </View>
    </View>
  );
...
exports.MinifyHorizontalProduct = (props) => {
  ...
  return (
    ...
    >
      <Image
        source={{ uri: `${productsImagesPath}/${product.images[0]}` }}
