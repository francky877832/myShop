...
export const LeftToRightViewBox = ({
  show,
  children,
  duration,
  from,
  ...
  return (
    <Animated.View style={[styles, animatedStyles]}>{children}</Animated.View>
  );
};

export const RightToLeftViewBox = ({
  show,
  children,
  to,
  from,
...
export const BottomToTopViewBox = ({
  show,
  children,
  duration,
  from,
