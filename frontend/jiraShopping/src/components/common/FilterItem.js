      ...
      <View style={[filterItemStyles.container, {}]}>
        ...
        {item.subCategories.map((it, index) => {
          return (
            <View
              activeOpacity={1}
              style={[filterItemStyles.checkBox]}
              key={index}
            >
              <CheckBox
                title={it.name}
                containerStyle={[filterItemStyles.contentContainer, {}]}
                textStyle={[customText.text, filterItemStyles.checkBoxText]}
                onPress={
                  (e) => {
                ...
                checked={
                  selectedModalCategories[
                    item.name + "/" + it.name
                  ] /*Si je viens de categories pour afficher toute la collection ou juste une sous-collection */ /*console.log(selectedCategories.name+"/"+selectedCategories.subCategories)*/ ||
      ...
      <View style={[filterItemStyles.container, {}]}>
        <View style={[filterItemStyles.title]}>
          <CheckBox
            ...
            onPress={() => {
              updateSelectedBrands(item.name);
            }}
          />
        </View>
      </View>
