...
const ProductsListWithFilters = React.forwardRef((props, ref) => {
    const { datas, horizontal, title, onEndReached, onEndReachedThreshold, onScroll, filters, notDisplayFilters, name, searchText, isLoading, 
        getDatas, display, onExit, setOnExit, minified, updateProdilLike,
    } = props;
            ...
            <View style={[productsListWithFiltersStyles.container]}>
                ...
                <View style={{flex:1,flexDirection:"column",}}>
                    {filters &&
                        ...
                        <ProductsList updateProdilLike={updateProdilLike}  minified={minified} name={name} onScroll={onScroll || function(){}} isLoading={isLoading} onEndReached={onEndReached||function(){}} onEndReachedThreshold={onEndReachedThreshold} ref={ref} datas={datas} horizontal={false} styles={preferencesStyles} />
                </View>
