...
const Filters = (props) => {
  ...
  const { categories, brands /*isLoading, setIsLoading*/ } =
  ...
  const orderByItem = [
    { id: 1, name: "Pertinence", attribut: "pertinence" },
    { id: 2, name: "Plus Cher", attribut: "prix-desc" },
    { id: 3, name: "Moins Cher", attribut: "prix-asc" },
    { id: 4, name: "Les Plus Aimés", attribut: "more-liked" },
    { id: 5, name: "Les Plus Consultés", attribut: "more-viewed" },
    { id: 6, name: "Plus Recents", attribut: "newer" },
    { id: 7, name: "Plus Anciens", attribut: "older" },
  ];
  ...
  return (
    <View
      style={[
        filtersStyles.contentContainerStyle,
        { height: modalFiltersVisible ? totalTopHeight : topHeight },
      ]}
    >
      ...
      )}
      {
        ...
        <View style={[filtersStyles.container]}>
          <View
            style={[
              filtersStyles.topMostContainer,
              { height: modalFiltersVisible ? totalTopHeight : topHeight },
            ]}
          >
            <View style={[filtersStyles.topContainer]}>
              <Pressable
                style={[
                  filtersStyles.trierFiltrer,
                  modalOrderByVisible
                    ? filtersStyles.trierFiltrerFocused
                    : false,
                ]}
                onPress={() => {
                  showFilters("trier");
              ...
              >
                ...
                <Text
                  style={[
                    customText.text,
                    modalOrderByVisible
                      ? filtersStyles.modalVisibleText
                      : false,
                  ]}
                >
                  Trier
              ...
              <Pressable
                style={[
                  ...
                  {
                    borderLeftWidth: 1,
                    borderLeftColor: appColors.secondaryColor3,
                  },
                  modalFiltersVisible
                    ? filtersStyles.trierFiltrerFocused
                    : false,
                ...
                onPress={() => {
                  navigation.navigate("FiltersSearch", {
                    notDisplayFilters: notDisplayFilters,
          ...
          <Modal
            visible={modalOrderByVisible}
            transparent={true}
            onRequestClose={() => setModalOrderByVisible(false)}
          >
            <Pressable
              style={[filtersStyles.orderByContainer]}
              onPress={() => setModalOrderByVisible(false)}
            >
              <View style={[filtersStyles.radioBox]}>
                <View style={[filtersStyles.modalHeader]}>
                  <Text
                    style={[customText.text, filtersStyles.modalHeaderText]}
                  >
                    Trier Par...
                  </Text>
                </View>
                <RadioButton.Group
                  ...
                  style={[filtersStyles.radioGroup]}
                >
              ...
              <View style={[filtersStyles.modal, {}]}>
                <View style={{ width: "100%" }}>
                    ...
                    /*modalFiltersVisible &&*/ modalPriceVisible && (
                      <View style={[filtersStyles.priceContainer]}>
                        ...
                        <View style={{ alignSelf: "center" }}>
                          <Text style={[customText.text, filtersStyles.label]}>
                            Price
                          </Text>
                        </View>
                        ...
                        <View style={[filtersStyles.price, {}]}>
                          <View style={[filtersStyles.minPrice]}>
                            <TextInput
                              ...
                              style={[
                                filtersStyles.input,
                                isMinPriceFocused && filtersStyles.inputFocused,
                              ]}
                              onFocus={() => setIsMinPriceFocused(true)}
                              onBlur={() => setIsMinPriceFocused(false)}
                              value={minPrice}
                              onChangeText={(price) =>
                                setMinPrice(formatMoney(price))
                              }
                            />
                          </View>
                          ...
                          <View style={[filtersStyles.maxPrice]}>
                            <TextInput
                              ...
                              style={[
                                filtersStyles.input,
                                isMaxPriceFocused && filtersStyles.inputFocused,
                              ]}
                              onFocus={() => setIsMaxPriceFocused(true)}
                              onBlur={() => setIsMaxPriceFocused(false)}
                              value={maxPrice}
                              onChangeText={(price) =>
                                setMaxPrice(formatMoney(price))
                              }
                            />
                          </View>
                        </View>
                  ...
                  {modalFiltersVisible && modalCategoryVisible && (
                    <View
                      style={[
                        filtersStyles.categoryContainer,
                        filtersStyles.cardItem,
                      ]}
                    >
                      <View style={{ alignSelf: "center" }}>
                        <Text style={[customText.text, filtersStyles.label]}>
                      ...
                      >
                        <FlatList
                          ...
                          renderItem={({ item }) => {
                            return (
                              <FilterItem
                                updateModalCategories={updateModalCategories}
                          ...
                          ItemSeparatorComponent={(item) => {
                            return (
                              <View
                                style={filtersStyles.categorySeparator}
                              ></View>
                            );
                          }}
                          horizontal={false}
                          ...
                          style={{}}
                        />
                        {isLoading && <CustomActivityIndicator styles={{}} />}
                      </View>
                      <View
                        style={{
                          flexDirection: "row",
