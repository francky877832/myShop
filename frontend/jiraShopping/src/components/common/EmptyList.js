  ...
  return (
    <View style={[emptyListStyles.container]}>
      <Icon
        ...
        size={iconSize}
        color={iconColor}
        style={[emptyListStyles.icon]}
      />
      <Text style={[emptyListStyles.text, emptyListStyles.text1]}>
        {message[0]}
      </Text>
      {giveFocus && (
        <Pressable
          style={[emptyListStyles.pressable]}
          onPress={() => {
            giveFocus();
          }}
        >
          <Text style={[emptyListStyles.text, emptyListStyles.text2]}>
            {message[1]}
          </Text>
        </Pressable>
      )}
