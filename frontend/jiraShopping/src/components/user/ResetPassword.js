  ...
  return (
    <View style={[{ flex: 1 }]}>
            ...
            leftIcon={
              <Pressable onPress={() => {}}>
                <Icon
                  ...
                  size={24}
                  color={
                    isEmailFocused ? appColors.secondaryColor1 : appColors.black
                  }
                />
              </Pressable>
            }
          ...
          <View>
            <View style={[userLoginStyles.credentialContainers]}>
              <Input
                ...
                inputContainerStyle={[
                  { borderBottomWidth: 1 },
                  isPassword1Focused && userLoginStyles.inputFocused,
                ]}
                leftIcon={
                  <Pressable onPress={() => {}}>
                    <Icon
            ...
            <View style={[userLoginStyles.credentialContainers]}>
              <Input
                ...
                inputContainerStyle={[
                  { borderBottomWidth: 1 },
                  isPassword2Focused && userLoginStyles.inputFocused,
                ]}
                leftIcon={
                  <Pressable onPress={() => {}}>
                    <Icon
      ...
      <CustomModalActivityIndicator
        ...
        size="large"
        color={appColors.secondaryColor1}
        message="Envoie de l'email de reinitialisation en cours..."
      />
    </View>
  );
};
