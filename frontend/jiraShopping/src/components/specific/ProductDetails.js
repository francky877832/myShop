        ...
        <>
            <View style={productDetailsStyles.buttonContainer}>
                ...
                <View style={productDetailsStyles.buttonContainerLeft}>
                    <ShareButton color={appColors.blue} size={24} styles={productDetailsStyles.shareButton} link={`${server}/product/${data._id}`} />
                    <View style={{ width: 10 }}></View>
                            
                    <LikeButton  _handleLikePressed={_handleLikePressed} noText={true} hasLikedItem={like} user={user} synchro={true} item={data} styles={{ color: appColors.clearBlack }} isCard={false} />
                </View>
            </View>
            
            <Animated.View style={[productDetailsStyles.carousselIamges, {height:height.current,},]}>
                <CarouselImage style={productDetailsStyles.carousselIamge} images={data.images} product={data} styles={{ }} />
            </Animated.View>
