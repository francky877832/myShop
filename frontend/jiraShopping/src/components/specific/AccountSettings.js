  ...
  const verifyEmail = async (email, password) => {
    ...
    try {
      ...
      if (!userCredential.user.emailVerified) {
        ...
        Alert.alert(
          "",
          "Vérification par email envoyée ! Vérifiez votre boîte de réception."
        );
      }
  ...
  return (
    <View style={[accountSettingsStyles.container]}>
          ...
          <ScrollView style={{ flex: 1 }}>
            ...
            <View style={[accountSettingsStyles.pp]}>
              <Pressable>
                <Image
                  source={{ uri: `${pp[0]}` }}
                  style={[accountSettingsStyles.imgeProfil]}
                />
              </Pressable>
              <Pressable
            ...
            <View style={[accountSettingsStyles.infosBox]}>
              <View style={[accountSettingsStyles.inputBox]}>
                <Text style={[accountSettingsStyles.text]}>
                  Nom D'utilisateur
                </Text>
                <Input
                  ...
                  inputContainerStyle={[
                    ...
                    isUsernameFocused && searchBarStyles.inputContainerFocused,
              ...
              <PhoneAuth
                ...
                tel={tel}
                setTel={setTel}
                isTelFocused={isTelFocused}
                setIsTelFocused={setIsTelFocused}
              ...
              <View style={[accountSettingsStyles.inputBox]}>
                  ...
                  {!user.isEmailVerified ? (
                    <View>
                      {!isEmailLoading && !hasSentEmail ? (
                        <Pressable
                          style={[accountSettingsStyles.verifier, {}]}
                          onPress={() => {
                        ...
                        <Pressable
                          style={[
                            accountSettingsStyles.verifier,
                ...
                <Input
                  placeholder="EX : thestyle@gmail.com"
                  value={email}
                  onChangeText={(email) => {
                    setEmail(email);
                  }}
                  ...
                  inputContainerStyle={[
                    searchBarStyles.inputContainer,
                    isEmailFocused && searchBarStyles.inputContainerFocused,
                    addProductStyles.inputContainer,
                  ]}
                />
              </View>
              ...
              {showPasswordInput && (
                <View>
                  ...
                  {hasSentEmail ? (
                    <Pressable
                      style={[accountSettingsStyles.confirmPassword]}
                      onPress={() => {
                    ...
                    <Pressable
                      style={[
                        accountSettingsStyles.confirmPassword,
                        { backgroundColor: appColors.green },
                      ]}
                      onPress={() => {
                        setCheckEmail((rev) => !prev);
                      }}
                    >
                      <Text
                        style={[{ color: appColors.white, fontWeight: "bold" }]}
                      >
                        J'ai Déja Validé Mon Email
                      </Text>
                    </Pressable>
                  )}
              ...
              <View style={[accountSettingsStyles.inputBox]}>
                <Text style={[accountSettingsStyles.text]}>
                  Slogan De Votre Boutique
                </Text>
                <Input
                  placeholder="EX : TheStyle, votre marque."
                  value={slogan}
                  onChangeText={(name) => {
                    setSlogan(name);
                  }}
                  ...
                  inputContainerStyle={[
                    searchBarStyles.inputContainer,
                    ,
                    isSloganFocused && searchBarStyles.inputContainerFocused,
                    addProductStyles.inputContainer,
                  ]}
                />
              </View>
      ...
      <CustomModalActivityIndicator
        ...
        size="large"
        color={appColors.secondaryColor1}
        message="Profil en cours de mise a jour..."
      />
    </View>
  );
};
