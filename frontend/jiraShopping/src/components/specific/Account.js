    ...
    <ScrollView style={[accountStyles.container, {}]}>
      <View style={[accountStyles.top]}>
        ...
        <View style={[accountStyles.firstLine]}>
          <Text style={[accountStyles.text, { fontWeight: "bold" }]}>
            @{truncateTextAndAddDots(user.username, 15)}
          </Text>
          <View style={[accountStyles.firstLineIcons]}>
            <Pressable
              style={[topStyles.notification]}
              onPress={() => {
      ...
      <View style={[accountStyles.settings]}>
        {settings.map((item, key) => {
          ...
          return (
            <View key={key}>
              <Pressable
                style={[
                  accountStyles.settingsElement,
                  !item.available ? accountStyles.unavailable : false,
                ]}
                onPress={() => {
        ...
        <Pressable
          style={[accountStyles.settingsElement]}
          onPress={() => {
            handleSharePress(storeUrl);
          }}
        >
          <Text style={[accountStyles.text, { fontSize: 18 }]}>
            Partager l'Appli
          </Text>
          <ShareButton
            size={30}
      ...
      <View style={{ padding: 2 }}>
        <Text
          style={[accountStyles.text, { fontSize: 18, color: appColors.gray }]}
        >
          Version 1.0.0
        </Text>
      </View>
