...
const renderTabBar = (props) => (
    <TabBar
      ...
      style={{ backgroundColor:appColors.secondaryColor3, borderColor:appColors.white, }} // Changez cette couleur pour la barre d'onglets
...
return(
  <View style={preferencesStyles.container}>
        ...
        <View style={[{flex:1,}]}>
          <View style={{flex:1}}>
              <TabView  
                lazy renderLazyPlaceholder={() => 
                <View style={[{justifyContent:'center',alignItems:'center'}]}>
                  <Text>Loading</Text>
                  </View>  } navigationState={{ index, routes }} renderScene={renderScene} onIndexChange={setIndex} initialLayout={initialLayout} renderTabBar={renderTabBar} 
              />
          </View>
    </View>
  </View>
