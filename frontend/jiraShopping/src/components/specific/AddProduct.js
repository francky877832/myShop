...
const AddProduct = (props) => {
  ...
  const { selectedBrand, selectedColor, setSelectedColor, setSelectedBrand } =
  ...
  const [kargoPrice, setKargoPrice] = useState(
    product.kargoPrice ? product.kargoPrice + "" : 0
  );
  ...
  const onBackPress = useCallback(
    (e) => {
      ...
      if (!hasAdded) {
        Alert.alert("Attention!", "Abandoné l'ajout de produit ?", [
    ...
    try {
      ...
      const datas = {
        ...
        category: !!selectedCategories.name
          ? `${selectedCategories.name}/${selectedCategories.subCategories}`
          : product.category,
      ...
      if (!product.name) {
        ...
        const response = await fetch(
          `${server}/api/datas/products/update/${product._id}`,
          {
            method: "PUT",
            body: formData,
            headers: {
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
              ...
              <View style={[addProductStyles.contents, { width: "100%" }]}>
                <View style={[{ flexDirection: "ro", width: "100%" }]}>
                  <View style={[addProductStyles.imageBox]}>
                    <Pressable
                      onPress={() => {
                        setCameraOrGalery(!cameraOrGalery);
                      }}
                    >
                      <Icon
                        name="camera-outline"
                  ...
                  >
                    {(images.length > 0
                      ? images.length < MAX_IMAGES
                        ? [...images, ...new Array(MAX_IMAGES - images.length)]
                        : images
                      : [1, 2, 3, 4, 5, 6]
                    ).map((item, index) => {
                      let source;
                      ...
                      const uri = source?.startsWith("file")
                        ? source
                        : `${productsImagesPath}/${source}`;

                      return (
                        <Pressable
                          style={[
                            addProductStyles.imageBox,
                    ...
                    >
                      <View style={addProductStyles.modalContainer}>
                        <Image
                          ...
                          style={addProductStyles.fullImage}
                        />
                        <Pressable
                          style={addProductStyles.closeButton}
                          onPress={() => setModalVisible(false)}
                        >
                          <Text style={addProductStyles.closeButtonText}>
                            Fermer
                          </Text>
                        </Pressable>
                      </View>
                  ...
                  {errors.images && (
                    <Text style={[formErrorStyle.text]}>{errors.images}</Text>
                  )}
                </View>
              </View>
            </View>
            ...
            <View style={[addProductStyles.containers]}>
              <View style={[addProductStyles.titles]}>
                <Text style={[addProductStyles.titlesText]}>
                  Nom Du Produit
                </Text>
              </View>
              ...
              <View style={[addProductStyles.contents]}>
                ...
                <View>
                  <Input
                    placeholder="EX : Samsung Galaxy Z-Fold"
                    value={valueName}
                    onChangeText={(name) => {
                      setValueName(name);
                    }}
                    ...
                    inputContainerStyle={[
                      ...
                      isNameFocused && searchBarStyles.inputContainerFocused,
                      addProductStyles.inputContainer,
                    ]}
                  />
                  {errors.name && (
                    <Text style={[formErrorStyle.text]}>{errors.name}</Text>
                  )}
                </View>
              </View>
            </View>
            ...
            <View style={[addProductStyles.containers]}>
              ...
              <View style={[addProductStyles.contents]}>
                ...
                <View>
                  <Input
                    placeholder="EX : Téléphone neuf, je l!ai juste utilisé 2 fois. 128 Go et 8 Go de Ram..."
                    value={valueDesc}
                    onChangeText={(desc) => {
                      setValueDesc(desc);
                    }}
                    ...
                    inputContainerStyle={[
                      searchBarStyles.inputContainer,
                      isDescFocused && searchBarStyles.inputContainerFocused,
                      addProductStyles.inputContainer,
                    ]}
                  />
                  {errors.description && (
                    <Text style={[formErrorStyle.text]}>
                      {errors.description}
                    </Text>
                  )}
                </View>
            ...
            <View style={[addProductStyles.containers]}>
              ...
              <View
                style={[
                  addProductStyles.contents,
                  addProductStyles.categoryContainer,
                ]}
              >
                <Pressable
                  style={[addProductStyles.pressableDetails]}
                  onPress={() => {
                    navigation.navigate("Categories", {
                      datas: { page: "category", goBackTo: "AddProduct" },
                ...
                <View style={{ padding: 5, paddingHorizontal: 10 }}>
                  {errors.category && (
                    <Text style={[formErrorStyle.text]}>{errors.category}</Text>
                  )}
                  {errors.brand && (
                    <Text style={[formErrorStyle.text]}>{errors.brand}</Text>
                  )}
                  {errors.color && (
                    <Text style={[formErrorStyle.text]}>{errors.color}</Text>
                  )}
                </View>
              </View>
            </View>
            ...
            <View style={[addProductStyles.containers]}>
              ...
              <View style={[addProductStyles.contents]}>
                ...
                <View>
                  ...
                  {errors.feesBy && (
                    <Text style={[formErrorStyle.text]}>{errors.feesBy}</Text>
                  )}
                </View>
              </View>
              ...
              <View style={[addProductStyles.containers]}>
                ...
                >
                  <Input
                    placeholder="Estimation des frais de transport. EX : 2500"
                    value={kargoPrice}
                    onChangeText={(price) => {
                      setKargoPrice(formatMoney(price));
                    }}
                    inputMode="numeric"
                    multiline={false}
                    placeholderTextColor={appColors.secondaryColor3}
                    ...
                    inputContainerStyle={[
                      searchBarStyles.inputContainer,
                      isKargoPrice && searchBarStyles.inputContainerFocused,
                      addProductStyles.inputContainer,
                    ]}
                  />

                  <View style={{}}>
                    <Text style={[customText.text, { fontStyle: "italic" }]}>
                      Ce detail n'est pas obligatoire. Mais s'il est renseigné,
                      nous aidera dans une estimation plus nette de vos gains{" "}
                    </Text>
                    {errors.kargoPrice && (
                      <Text style={[formErrorStyle.text]}>
                        {errors.kargoPrice}
            ...
            <View style={[addProductStyles.containers]}>
              ...
              <View style={[addProductStyles.contents]}>
                ...
                <Input
                  placeholder="Garanti en Mois"
                  value={valueGaranti}
                  onChangeText={(garanti) => {
                    setValueGaranti(garanti);
                  }}
                  inputMode="numeric"
                  multiline={false}
                  placeholderTextColor={appColors.secondaryColor3}
                  ...
                  inputContainerStyle={[
                    searchBarStyles.inputContainer,
                    isGarantiFocused && searchBarStyles.inputContainerFocused,
                    addProductStyles.inputContainer,
                  ]}
                />
                ...
                <Input
                  ...
                  inputContainerStyle={[
                    searchBarStyles.inputContainer,
                    isStockFocused && searchBarStyles.inputContainerFocused,
                    addProductStyles.inputContainer,
                  ]}
                />
              </View>
              ...
              >
                {errors.garanti && (
                  <Text style={[formErrorStyle.text]}>{errors.garanti}</Text>
                )}
                {errors.stock && (
                  <Text style={[formErrorStyle.text]}>{errors.stock}</Text>
                )}
            ...
            <View style={[addProductStyles.containers]}>
              ...
              >
                ...
                >
                  ...
                  <Text style={[{ color: appColors.secondaryColor1 }]}>
                    Details
                  </Text>
                </Pressable>
              </View>
              ...
              <View style={[addProductStyles.contents]}>
                ...
                {product.price && (
                  <Input
                    placeholder="EX : 2500"
                    value={formatMoney(product.newPrice)}
                    onChangeText={(price) => {
                      setValuePrice(formatMoney(product.newPrice));
                    }}
                    inputMode="numeric"
                    editable={false}
                    multiline={false}
                ...
                <Input
                  placeholder={product.price ? "Nouveau prix" : "Prix produit"}
                  value={formatMoney(valuePrice)}
                  onChangeText={(price) => {
                    setValuePrice(formatMoney(price));
                  }}
                  inputMode="numeric"
                  multiline={false}
                  placeholderTextColor={appColors.secondaryColor3}
                  ...
                  inputContainerStyle={[
                    searchBarStyles.inputContainer,
                    isPriceFocused && searchBarStyles.inputContainerFocused,
                    addProductStyles.inputContainer,
                  ]}
                />
              </View>
              ...
              >
                {errors.price && (
                  <Text style={[formErrorStyle.text]}>{errors.price}</Text>
                )}
                <View style={{ height: 10 }}></View>
              </View>
            </View>
      ...
      {cameraOrGalery && (
        ...
        <BottomToTopViewBox
          ...
          from={100}
          to={0}
          styles={addProductStyles.bottomPicker}
        >
