...
const SColors = (props) => {
  ...
  const [selectedLocalColors, setSelectedLocalColors] = useState(
    selectedColorFromContext
  );
            ...
            if (item.name != "multicolor") {
              return (
                <View style={[sCategoriesStyles.pressableColorContainer]}>
                  <Pressable
                    style={[sCategoriesStyles.pressableColor]}
                    onPress={() => {
                  ...
                  >
                    <View
                      style={[
                        sCategoriesStyles.colorMulticolor,
                        {
                    ...
                    >
                      {selectedLocalColors[item.name] && (
                        <Icon
                          ...
                          style={sCategoriesStyles.iconCheck}
                        />
                      )}
                    </View>
                    <Text
                      style={[
                        ...
                        { paddingTop: 10, color: appColors.secondaryColor5 },
                      ]}
                    >
                ...
                <View style={[sCategoriesStyles.pressableColorContainer]}>
                  ...
                  >
                    <ImageBackground
                      ...
                      imageStyle={[sCategoriesStyles.colorMulticolor]}
                      style={[sCategoriesStyles.colorMulticolor]}
                    >
                      {selectedLocalColors[item.name] && (
                        <Icon
                          name="checkmark-circle"
